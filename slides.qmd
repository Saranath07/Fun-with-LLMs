...
:::
<!-- ![](path/to/cloud_infrastructure_image.png){width=150px}
![](path/to/jenkins_image.png){width=150px}
![](path/to/docker_image.png){width=150px}
![](path/to/prometheus_image.png){width=150px}
![](path/to/grafana_image.png){width=150px} -->