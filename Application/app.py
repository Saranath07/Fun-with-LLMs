...
# Finetuned Model
from trainLLAMA.test import generate_proposal
...
def generate_proposal(requirements):
    """
    Generate a proposal based on client requirements without using Celery.
    
    :param requirements: Client requirements as input string.
    :return: Generated proposal as a string.
    """
    # Load LLM and retrieval models
    ...
    # Step 1: Executive Summary
    exec_summary = executive_summary_rag(requirements=requirements)
    print("Executive Summary:")
    print(exec_summary.data, "\n")

    # Step 2: Client Needs Analysis
    client_needs = client_needs_rag(requirements=requirements)
    print("Client Needs Analysis:")
    print(client_needs.data, "\n")

    # Step 3: Proposed Solution
    proposed_solution = proposed_solution_rag(requirements=requirements)
    print("Proposed Solution:")
    print(proposed_solution.data, "\n")

    # Step 4: Feasibility Study
    feasibility_study = feasibility_study_rag(requirements=requirements)
    print("Feasibility Study:")
    print(feasibility_study.data, "\n")

    # Step 5: Timeline and Milestones
    timeline = timeline_rag(requirements=requirements)
    print("Timeline and Milestones:")
    print(timeline.data, "\n")

    # Step 6: Pricing and Payment Terms
    pricing_payment = pricing_payment_rag(requirements=requirements)
    print("Pricing and Payment Terms:")
    print(pricing_payment.data, "\n")

    # Step 7: Next Steps
    next_steps = next_steps_rag(requirements=requirements)
    print("Next Steps:")
    print(next_steps.data, "\n")

    # Combine all sections into a final proposal
    proposal = f"""# Executive Summary \n {exec_summary.data}
